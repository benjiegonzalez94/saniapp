...
/**
 * Portada. Vive en `(publico)` para que la cabecera, el pie y el `main` con el
 * ancla «Saltar al contenido» los ponga el layout del grupo: cuando esta página
 * los montaba por su cuenta había dos armazones que mantener en paralelo, y el
 * pie —donde viven los enlaces legales obligatorios— era justo la parte que no
 * puede divergir entre la portada y las páginas de aviso legal.
 */
